...
namespace Nascimento.Software.LocaCar.Api.Migrations
{
    public partial class ScriptInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoriesPrices",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    Price_StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Price_FinishDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesPrices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoriesPrices_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RentStart_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RentEnd_Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarRents_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesPrices_CategoryId",
                table: "CategoriesPrices",
                column: "CategoryId");
